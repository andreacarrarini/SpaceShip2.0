...
public class TableActivity2_1 extends Activity implements View.OnTouchListener, View.OnDragListener {
    ...
    public void restartShiptable(Button button) {
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TableActivity2_1.this, TableActivity2_1.class);
