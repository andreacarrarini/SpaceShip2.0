...
public class BluetoothConnectionService2 {
    ...
    private static UUID MY_UUID_INSECURE=null; //= UUID.fromString("8ce255c0-200a-11e0-ac64-0800200c9a66");
    ...
    public synchronized void connect(BluetoothDevice device, boolean secure) {
        ...
        MY_UUID_INSECURE = list[0].getUuid();
    ...
    private void connectionFailed() {
        ...
        BluetoothConnectionService2.this.start();
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState == STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BluetoothConnectionService2.this) {
                        switch (mState) {
                            case STATE_LISTEN:
                                break;
                            case STATE_CONNECTING:
                                ...
                                break;
                            case STATE_NONE:
                                System.out.println("state_none of socket");
                                break;
